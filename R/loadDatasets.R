...
#' Load feature weights for permutated data
#'
...
#' @return A tibble containing all of the feature weight data for the permutated datasets.
#' @export
load_permutated_fws <- function(pathtofile,featureWeightColumnName){
